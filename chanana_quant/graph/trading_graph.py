# Chanana Quant/graph/trading_graph.py
...
from chanana_quant.agents.utils.memory import FinancialSituationMemory
from chanana_quant.agents.utils.agent_states import (
    AgentState,
    InvestDebateState,
    RiskDebateState,
)
from chanana_quant.dataflows.config import set_config

# Import the new abstract tool methods from agent_utils
from chanana_quant.agents.utils.agent_utils import (
    get_stock_data,
    get_indicators,
    get_fundamentals,
    get_balance_sheet,
...
class ChananaQuantGraph:
    ...
    def _log_state(self, trade_date, final_state):
        ...
        # Save to file
        directory = Path(f"eval_results/{self.ticker}/ChananaQuant_logs/")
        directory.mkdir(parents=True, exist_ok=True)

        with open(
            f"eval_results/{self.ticker}/ChananaQuant_logs/full_states_log_{trade_date}.json",
            "w",
        ) as f:
