...
app = typer.Typer(
    name="Chanana Quant",
    help="Chanana Quant — AI-native hedge fund architecture for Indian markets",
...
def update_display(layout, spinner_text=None, stats_handler=None, start_time=None):
    ...
    layout["header"].update(
        Panel(
            "[bold green]Welcome to Chanana Quant[/bold green]\n"
            "[dim]AI-native hedge fund architecture for Indian markets[/dim]",
            title="Chanana Quant",
            border_style="green",
            padding=(1, 2),
            expand=True,
...
def get_user_selections():
    ...
    welcome_content += "[bold green]Chanana Quant — AI-native hedge fund architecture for Indian markets[/bold green]\n\n"
    welcome_content += "[bold]Workflow Steps:[/bold]\n"
    welcome_content += "I. Analyst Team → II. Research Team → III. Trader → IV. Risk Management → V. Portfolio Management\n\n"
    welcome_content += (
        "[dim]Multi-agent market research and trading intelligence[/dim]"
    )
    ...
    welcome_box = Panel(
        ...
        padding=(1, 2),
        title="Chanana Quant",
        subtitle="AI-native hedge fund architecture",
    )
